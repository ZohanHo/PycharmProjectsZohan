...
a = int(input("Введите количество учиников в класе 1: "))
b = int(input("Введите количество учиников в класе 2: "))
c = int(input("Введите количество учиников в класе 3: "))

z = ((a+b+c)+1) // 2

print("Всего нужно парт: ", z)
